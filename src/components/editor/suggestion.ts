...
import { findSuggestionMatch, SuggestionMatch } from "./findSuggestionMatch";
    ...
    state: {
      ...
      apply(transaction, prev) {
        ...
        if (selection.from === selection.to) {
          ...
          const matched = match as SuggestionMatch;

          // If we found a match, update the current state to show it
          if (match && allow({ editor, range: matched!.range })) {
            next.active = true;
